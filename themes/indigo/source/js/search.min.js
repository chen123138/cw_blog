(function () {
        ...
        (n = t.length
            ? t
                  .map(function (t) {
                      return e(v, {
                          title: t.title,
                          path: (o.BLOG.ROOT + "/" + t.path).replace(
                              /\/{2,}/g,
                              "/"
                          ),
    ...
    var r,
        ...
        w = {
            show: function () {
                o.innerWidth < 760 ? O.classList.add("lock-size") : m,
                    h.classList.add("in");
            },
            hide: function () {
                o.innerWidth < 760 ? O.classList.remove("lock-size") : m,
                    h.classList.remove("in");
            },
        };
    u.addEventListener(c, function () {
        f.classList.toggle("in"),
            (d.value = ""),
            f.classList.contains("in") ? d.focus() : d.blur();
    }),
